...
- Use `.github/workflows/versioning.yml` to bump `package.json` and `package-lock.json`, push the `vX.Y.Z` tag and create the GitHub Release.
- Keep `.github/workflows/release.yml` focused on npm publishing from a published GitHub Release.
